          ...
          <motion.div {...fadeUp} className="bg-[#2C1506] rounded-2xl p-8 shadow-xl text-[#FDF6EC] space-y-6">
            ...
            <div className="border-t border-[#FDF6EC]/10 pt-5">
              ...
              <div className="flex gap-4">
                <a href="https://www.facebook.com/thebakinglab" target="_blank" rel="noopener noreferrer" className="group relative w-10 h-10 border border-[#D4A017] rounded-full flex items-center justify-center text-[#D4A017] hover:bg-[#D4A017] hover:text-[#3B1A0A] transition duration-200">
                ...
                <a href="https://www.instagram.com/thebakinglab" target="_blank" rel="noopener noreferrer" className="group relative w-10 h-10 border border-[#D4A017] rounded-full flex items-center justify-center text-[#D4A017] hover:bg-[#D4A017] hover:text-[#3B1A0A] transition duration-200">
